...
public class InventoryItem {
     ...
     */
    public InventoryItem(int itemId, String itemName, int quantity, Date expirationDate, double retailerPrice, boolean isDonation, boolean isSale, double discountPrice) {
        this.itemId = itemId;
