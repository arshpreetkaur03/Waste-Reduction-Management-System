...
public class ClaimsDAOTest {
    ...
    public void testAddClaim() throws SQLException {
        ...
        assertTrue("Initial claim should be added.", addResult);
    }
    ...
    public void testAddOrUpdateClaim() throws SQLException {
        ...
        assertTrue("Claim should be updated successfully.", updateResult);
    }
    ...
    public void testExistsClaimForItem() throws SQLException {
        ...
        assertTrue("Claim should exist for item.", exists);
    }
    ...
    public void testUpdateQuantityClaimed() throws SQLException {
        ...
        assertTrue("Quantity claimed should be updated successfully.", updated);
    }
